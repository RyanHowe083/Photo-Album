...
public class consoleApp {
	...
	private static ArrayList<Album> createAlbumList(StringBuffer responseContent) throws JsonParseException, IOException {
		//Now use a parser to get the information from the responseContent and after the info from one album is parsed add the object to a list
	...
	/**
	 * This method gets the user specified album to display and then loops through the list to do so
	 * @param list
	 */
